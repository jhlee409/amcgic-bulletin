    ...
    with tab2:
        ...
        with st.expander("AI 소화기 환자 병력 청취 훈련 프로그램 내용을 보려면 여기를 눌러주세요"):
            st.markdown(
                ...
                1. [GI training program](https://gi-training.streamlit.app/)에 접속하는데, ID는 이메일 주소, PW는 숫자글자섞어서 8자이상의 PW를 이진혁 교수님에게 이메일로 보내어 허락받고 등록한 후 접속가능합니다.
                ...
                1. AI의 두 가지 질문에 답하면 약 50초 기다렸다가 선생님이 질문하지 않았던 항목을 찾아 줍니다. 단 완전치는 않으니 참고만 하세요.
        ...
        with st.expander("EGD 사진 진단 훈련 프로그램의 내용을 보려면 여기를 눌러주세요"):
            st.markdown(
                ...
                1. 가장 먼저 왼쪽 sidebar에서 F1이나 F2를 선택합니다. 가능하면 F1, F2를 모두 공부하길 권합니다.
                1. 다음 EGD 사진을 선택하면 증례 사진과 질문이 보입니다.
                1. 질문에 대한 답을 충분히 생각해 보고, '진행' 버튼을 누르면 답과 이 증례를 통해 알아야 할 지식이 보입니다. 자신의 답과 비교해 보세요.
                1. 내 EGD 진단 능력의 60% 정도가 포함되어 있다고 평가합니다. 단순히 읽기만 하지 말고 관련 자료를 찾아 철저히 공부해 두면 머지 않아 능력있는 EGD 전문가가 될 수 있습니다.
