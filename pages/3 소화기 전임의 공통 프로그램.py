    ...
    with tab2:
        ...
        with st.expander("AI EGD 사진 진단 훈련 프로그램의 내용을 보려면 여기를 눌러주세요"):
            st.markdown(
                ...
                1. [GI training program](https://gi-training.streamlit.app/)에 접속하고, ID는 amcgi, PW는 3180을 입력하면 사용할 수 있습니다.
                1. 가장 먼저 왼쪽 sidebar에서 EGD 사진을 선택하고 완료될 때까지 기다립니다.
                1. 완료되면 아래의 '이전 기록 삭제 버튼'을 눌러 이전 기록을 삭제해야 합니다.
                1. 완료되면 case instruction 파일을 선택하고 기다렸다가 작업이 완료되면, 보여지는 병변의 impression을 아래 입력창에 입력하고 엔터를 칩니다.
                1. 좀 기다리면 권장 답안과 비교를 하여 점수를 알려 준 후 두 가지 질문을 하고 답에 대해 평가해 줍니다.
                1. 이 증례에 대해 추가로 궁금한 사항이 있으면 질문하면 정해진 내용 안에서는 대답해 줍니다.
                1. 매년 4월부터 다음 해 2월까지 매월 1일에 새로운 증례를 올립니다. 1년차용과 상부 2년차 용으로 나눠져 있으며, 매월 총 19 증례 정도가 새로 upload됩니다.
                '''
            ) 
