        ...
        st.markdown(
            '''
                ...
                1. 소화기 내시경 교육 동영상은 서울아산병원 시뮬레이션 센터 [Sim Class](https://edu.amc.seoul.kr/)에서 시청할 수 있습니다.
                    * ID와 PW는 각자 사번(ex: D240000)으로 설정되어 있습니다. 로그인 후 반드시 ★개인정보수정(e-mail 주소, 핸드폰번호, 영문명 등)★ 부탁드립니다. 로그인 및 Sim Class 관련 문의는 시뮬레이션센터 류수지(T.1018) 에게 아산웍스 또는 유선으로 문의바랍니다.
                    * 필요한 동영상을 청취하면 자동으로 출석 처리 됩니다.
                1. AI 소화기 환자 병력 청취 훈련 프로그램은 [GI training program](https://gi-training.streamlit.app/) 웹페이지에 접속하여 ID는 amcgi이고, PW는 3986을 입력하시면 사용하실 수 있습니다.
                ...
                ---------------------------------------------------------------------------------------------------------------------------------------------------------
                1. 3월 22일 현재 EGD 교육 프로그램 운영은 정지된 상태입니다. 상황이 호전되면 다시 시작할 것이고 변동 사항은 이 게시판을 통해 알려 드리겠습니다.
                '''
