        ...
        st.markdown(
            '''
                1. 소화기 내시경 교육 동영상은 서울아산병원 시뮬레이션 센터 [Sim Class](https://edu.amc.seoul.kr/)에서 시청할 수 있습니다.
                    1.1 ID 와 PW를 받아서 로그인 합니다.
                    1.1 필요한 동영상을 청취하면 자동으로 출석 처리 됩니다.
                ...
                ---------------------------------------------------------------------------------------------------------------------------------------------------------
                1. 24년 2월 1일부터 정식으로 게시판이 운영됩니다. 아직 ID와 PW 등록하지 않은 GI 프로퍼 내과전공의 3년차 선생님들이 있습니다. 3년차 대표는 모두 등록하도록 점검해 주세요.
                1. 2월 후반부부터 3월 전반부에는 전임의 1년차 선생님들 중에서 외부출신과 AMC 출신 중 EGD 교육 않받았던 선생님들의 EGD 교육이 있습니다.
                    1.1 MT, SHT, EMT 과정을 한 달 안에 이수해야 합니다.
                    1.1 변소영 선생님께서는 해당 선생님들과 일정을 상의해서 교육이 진행되도록 해주세요.
