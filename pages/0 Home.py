    ...
    with st.container():
        ...
        st.markdown(
            '''
                ...
                1. AI 소화기 환자 병력 청취 훈련 프로그램은 [GI training program](https://gi-training.streamlit.app/) 웹페이지에 접속하여 ID는 amcgi이고, PW는 3180을 입력하시면 사용하실 수 있습니다.
                ...
                ---------------------------------------------------------------------------------------------------------------------------------------------------------
                1. 2월19일 현재 상황으로인해 교육 프로그램 운영은 중지합니다. 상황이 호전되면 다시 시작할 것이고 변동 사항은 이 게시판을 통해 알려 드리겠습니다. AI 훈련 프로그램은 3월까지는 열지 않고 4월부터 시작하겠습니다.
                '''
