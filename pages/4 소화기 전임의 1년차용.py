...
if st.session_state.get('logged_in', False):  # 로그인 상태 확인
    ...
    with tab1:
        ...
        st.markdown(
            ...
            1. [GI training program](https://gi-training.streamlit.app/)에 올려져 있는 교육 자료들은 매우 충실하게 잘 만든 교육자료 입니다. 시기별로 자기에게 맞는 내용을 꼭 반복해서 학습하세요.
    ...
    with tab2:
        ...
        with st.expander("EGD variation 강의 내용을 보려면 여기를 눌러주세요"):
            st.markdown(
                ...
                1. 강의 동영상은 [GI training program](https://gi-training.streamlit.app/)에 올려져 있고, 보통은 5월이나 6월 정도면 절실하게 필요한 내용이 들어 있습니다.
        ...
        with st.expander("Hemostasis simulator training 내용을 보려면 여기를 눌러주세요"):
            st.markdown(
                ...
                1. 훈련 전 [GI training program](https://gi-training.streamlit.app/)에 올려져 있는 EGD Hemostasis 강의 동영상을 충분히 보고 훈련에 임하기 바랍니다. 특정 종목에서는 협찬한 회사에서 사전 발표를 하는 경우도 있겠습니다.
        ...
        with st.expander("PEG simulator training 내용을 보려면 여기를 눌러주세요"):
            st.markdown(
                ...
                1. 훈련 전 [GI training program](https://gi-training.streamlit.app/)에 올려져 있는 PEG 강의 동영상을 충분히 보고 훈련에 임하기 바랍니다.
