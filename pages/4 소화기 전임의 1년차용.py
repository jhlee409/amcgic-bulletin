...
if st.session_state.get('logged_in', False):  # 로그인 상태 확인
    ...
    with tab1:
        ...
        st.markdown(
            ...
            1. AI 환자 병력 청취 훈련 프로그램은 매우 강력한 프로그램입니다. 완전히 자기 것이 될 정도로 훈련하면 외래 진료를 능숙하게 할 수 있게 될겁니다.
            1. EGD Dx. 진단 훈련 프로그램은 매우 강력한 프로그램입니다. 여러분이 알아야 할 거의 모든 증례를 다룹니다. 완전히 자기 것이 될 정도로 훈련하면 실력향상에 큰 도움이 되니 열심히 하세요.
        '''
        )
    with tab2:
