...
if st.session_state.get('logged_in', False):  # 로그인 상태 확인
    ...
    with tab1:
        ...
        st.markdown(
            ...
            1. [GI training program](https://gi-training.streamlit.app/)에 올려져 있는 교육 자료들은 1년차 뿐 아니라 여러분에게도 매우 도움이 되는 내용들이니 꼭 보기 바랍니다.
    ...
    with tab2:
        ...
        with st.expander("바람직한 EUS, ESD training 요령의 내용을 보려면 여기를 눌러주세요"):
            st.markdown(
                ...
                1. 또한 [GI training program](https://gi-training.streamlit.app/)에 올려져 있는 Dx. EUS 강의 3개도 반드시 시청하기 바랍니다.
